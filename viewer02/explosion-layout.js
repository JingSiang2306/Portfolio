...
// breadboard, switch and their holders together as an electronics tray.
...
export const EXPLOSION_LAYOUT = [
  ...
  { name: 'Battery', members: ['Battery'], offset: [0, 1.35, 0] },
  { name: 'Electronics tray', members: ['Breadboard', 'SPC Holder', 'Battery Holder', 'SPC1520', 'Slide Switch'], offset: [0, 1.65, 0] },
  { name: 'Lid', members: ['Top Holder', 'Screw 10'], offset: [0, 2.25, 0] }
];
