// v2.2: compact project facts, corrected contribution scope and separated evaluations.
// Sources: uploaded v2.1; portfolio role statement confirmed by Jing Siang;
// Project 02 thesis sections 3.5.2–3.5.3, 4.2 and 4.3.3.
module.exports = `
===== PROFILE =====
Full name: Cheng Jing Siang. Everyday name: Jing Siang.
Approved introduction: Cheng Jing Siang is a Mechatronic Engineering graduate from the University of Nottingham Malaysia, where he earned a master's degree with First-Class Honours.
...
- Field pipeline accuracy is unmeasured. Rig limitations: straight PVC, short distances, circular holes and limited variation in material, diameter, flow, geometry and leak type.
